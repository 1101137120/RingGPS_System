...
exports.postRingDataDB = function(req, res,next) {
 ...
 //   if (err) throw err;
		...
		console.log("GPRMCandAlength"+GPRMCandA.length);
...
//	}
		...
		//console.log("到這");
		console.log("nmeadata.length"+nmeadata.length);
		console.log("GPRMCandA.length"+GPRMCandA.length);
	var status= "success";
...
//console.log("rel OK~~~~~~~~~~flightdetail insert");				
			}
		});				
			...
			//console.log("ar_height"+ar_height);
			ar_speed = speedtotal/hrelcount;
			//console.log("ar_speed"+ar_speed);
			//console.log("rel_ar_speedest"+rel_ar_speedest);
			//console.log("explosiveforce"+explosiveforce);
			...
			//console.log("relspeedtotal"+relspeedtotal);
			//console.log("relspeedlg"+relspeedlg);
			//console.log("rel_ar_speed"+rel_ar_speed);
			total_time=Timetol(start_time,end_time);
			//console.log("total_time"+total_time);
			//console.log("heightest"+heightest);
			//console.log("speedest"+speedest);
		//	console.log("ringRealID"+ringRealID);
			...
			flightDataInstance.set('dataType', ringstatus);
			flightDataInstance.set('gpsDataCount', nmeadata.length);
	
			//flightDataInstance.set('ringID', ringRealID);
			flightDataInstance.save(function(err){
			//console.log("flightDataInstance");
						if(err) 
						{
							console.log(JSON.stringify(err));
					//		console.log("flightid"+flightid);
