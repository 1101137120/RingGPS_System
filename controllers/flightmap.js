...
exports.postFlightMap = function(req, res,next) {
	...
	{
		console.log("Not in");
		var sql = "select * from flight_details WHERE flight_id='"+flightId+"'";
...
console.log("No");
			...
			{
				datailrows = rows;
				var sql = "select * from flight_data WHERE id='"+flightId+"'";	
			...
			if(err) 
				...
				}else
				{
					...
					apiOutput.response = datailrows;
					apiOutput.flightresponse = rows;					
					res.json(apiOutput);
